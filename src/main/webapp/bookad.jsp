...
<html>
    ...
    <body>
        ...
        <div id="container">
            <div id="containerbox">
                <div id="containerheader"  >Books Ad</div>
                ...
                <div id="formcontainer">
                    <s:form action="bookadAction" theme="simple">
                        <div class="title" align="center">Books Ad</div>
                        <div class="clear"></div>
                        <div class="formrow">
                        ...
                        <div class="formrow">
                            ...
                            <div class="form-widget"> <select name="iphone" required="true" onChange="if(this.value!=''){document.getElementById('fruit').src='images/bbimage/'+this.value+'.jpg';}">
