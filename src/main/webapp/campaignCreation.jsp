...
<html>
    ...
    <body>
        ...
        */%>
        ...
        <div style="height:650px; font-size:18px; font-family:'MS Serif', 'New York', serif; color:#000; vertical-align:middle;" align="center" > 
            <br/>
            <br/>
            <div align="center" id="stepWrapper">
                <table id="steps" class="firstSelected" width="920px" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="selected">Step 1- Campaign Info</td>
                        <td>Step 2- Ad Type</td>
            ...
            <s:form action="campaignMain">
                ...
                <s:select name="promotype"  label="Promotype" headerKey="Please select" headerValue="Please select" required="true"
                          list="{'Website','BlackBerry Application Ad','Android Application Ad','Iphone Application Ad','iTunes Media Ad','Streaming Video Ad','Books Ad','Click to Call Ad','Click to Map Ad'}" />
