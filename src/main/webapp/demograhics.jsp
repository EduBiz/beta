...
<div style="height:600px; font-size:18px; font-family:'MS Serif', 'New York', serif; color:#000; vertical-align:middle;" align="center" > 
        <br/>
          <h1>Demographics</h1>
         <div align="center" id="stepWrapper">
                <table id="steps" class="firstSelected" width="920px" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td class="selected">Step 3- Demographics</td>
